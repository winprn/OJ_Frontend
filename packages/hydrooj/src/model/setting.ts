...
export const Setting = (
    ...
    if (name === 'showInvisibleChar') {
        name = 'show_invisible_char';
...
SystemSetting(
    ...
    Setting('setting_limits', 'limit.problem_files_size_max', 256 * 1024 * 1024, 'number', 'limit.problem_files_size_max', 'Max files size per problem'),
